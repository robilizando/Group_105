...
app.layout = html.Div([
    dcc.Dropdown(
        ...
        multi = True,
        value = ['Minor', 'Medium', 'Substantial'], style=dict(width='76%', padding='0px')
    ),
    ...
    dcc.RangeSlider(
        ...
        step = 1,
        value = [1990, 2002]
    )], style=dict(width='60%', padding='5px')), 
    ...
    )], style=dict(width='60%', padding='30px')),
    ...
    html.Iframe(
        ...
        width = '800',
        style = {'border-width': '0'},
    )], style=dict(width='60%', padding='10px')),
